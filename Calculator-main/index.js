...
function printNum(){
    ...
    n1.addEventListener("click",function(){
        document.querySelectorAll(".calcDisplay h1")[0].innerHTML += document.getElementsByClassName("ns")[6].innerHTML
    })
    var n2 = document.getElementsByClassName("ns")[7];
    n2.addEventListener("click",function(){
        document.querySelectorAll(".calcDisplay h1")[0].innerHTML += document.getElementsByClassName("ns")[7].innerHTML
    })
    var n3 = document.getElementsByClassName("ns")[8];
    n3.addEventListener("click",function(){
        document.querySelectorAll(".calcDisplay h1")[0].innerHTML += document.getElementsByClassName("ns")[8].innerHTML
    })
    var n4 = document.getElementsByClassName("ns")[3];
    n4.addEventListener("click",function(){
        document.querySelectorAll(".calcDisplay h1")[0].innerHTML += document.getElementsByClassName("ns")[3].innerHTML
    })
    var n5 = document.getElementsByClassName("ns")[4];
    n5.addEventListener("click",function(){
        document.querySelectorAll(".calcDisplay h1")[0].innerHTML += document.getElementsByClassName("ns")[4].innerHTML
    })
    var n6 = document.getElementsByClassName("ns")[5];
    n6.addEventListener("click",function(){
        document.querySelectorAll(".calcDisplay h1")[0].innerHTML += document.getElementsByClassName("ns")[5].innerHTML
    })
    var n7 = document.getElementsByClassName("ns")[0];
    n7.addEventListener("click",function(){
        document.querySelectorAll(".calcDisplay h1")[0].innerHTML += document.getElementsByClassName("ns")[0].innerHTML
    })
    var n8 = document.getElementsByClassName("ns")[1];
    n8.addEventListener("click",function(){
        document.querySelectorAll(".calcDisplay h1")[0].innerHTML += document.getElementsByClassName("ns")[1].innerHTML
    })
    var n9 = document.getElementsByClassName("ns")[2];
    n9.addEventListener("click",function(){
        document.querySelectorAll(".calcDisplay h1")[0].innerHTML += document.getElementsByClassName("ns")[2].innerHTML
    })
    var n0 = document.getElementsByClassName("ns")[9];
    n0.addEventListener("click",function(){
        document.querySelectorAll(".calcDisplay h1")[0].innerHTML += document.getElementsByClassName("ns")[9].innerHTML
    })
    var addBtn = document.getElementsByClassName("op")[0];
    addBtn.addEventListener("click",function(){
        document.querySelectorAll(".calcDisplay h1")[0].innerHTML += document.getElementsByClassName("op")[0].innerHTML
    })
    var subBtn = document.getElementsByClassName("op")[1];
    subBtn.addEventListener("click",function(){
        document.querySelectorAll(".calcDisplay h1")[0].innerHTML += document.getElementsByClassName("op")[1].innerHTML
    })
    var mulBtn = document.getElementsByClassName("op")[3];
    mulBtn.addEventListener("click",function(){
        document.querySelectorAll(".calcDisplay h1")[0].innerHTML += '*' /*document.getElementsByClassName("op")[3].innerText*/
    })
    var divBtn = document.getElementsByClassName("op")[2];
    divBtn.addEventListener("click",function(){
        document.querySelectorAll(".calcDisplay h1")[0].innerHTML += document.getElementsByClassName("op")[2].innerHTML
    })
    var dotBtn = document.querySelectorAll(".numbers")[12];
        dotBtn.addEventListener("click",function(){
            document.querySelectorAll(".calcDisplay h1")[0].innerHTML += document.querySelectorAll(".numbers")[12].innerHTML
        })
...
function getDisplayText(){
   var num1 = document.querySelectorAll(".calcDisplay h1")[0].innerHTML;
   return num1;
}
...
function equalBtn (){
    ...
    document.getElementsByClassName("reset")[1].addEventListener("click", function(){
        document.querySelectorAll(".calcDisplay h1")[0].innerHTML = "";
    })
    document.getElementsByClassName("reset")[0].addEventListener("click", function(){
        var del = getDisplayText().slice(0,-1);
        document.querySelectorAll(".calcDisplay h1")[0].innerHTML = del;
    })
    document.getElementsByClassName("equal")[0].addEventListener("click", function(){
        calcBrain();
        document.querySelectorAll(".calcDisplay h1")[0].innerHTML = calcBrain();
    });
}
